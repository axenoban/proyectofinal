<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    <a class="navbar-brand fw-bold" href="/proyectofinal/views/dashboard.php"><i class="bi bi-fork-knife"></i> FAST FOOD</a>
    ...
    <div class="collapse navbar-collapse" id="navbarContent">
      ...
      <span class="navbar-text text-white me-3">
        Usuario:  <?= htmlspecialchars($_SESSION['user']['nombre'] ?? 'Invitado') ?>
      </span>
